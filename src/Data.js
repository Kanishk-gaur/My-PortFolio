...
export const projectlist = [
  ...
  {
    id: 1,
    title: "NewsMonkey-- NEWS website",
    des: "I created a news website with different sections for various categories, utilizing an API to provide the latest news",
